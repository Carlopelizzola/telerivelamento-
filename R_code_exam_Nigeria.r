...
pdf("DVI_2015_plot.pdf")
plot(dvi_2015, col=cl)
title(main="DVI 2015")
dev.off()
...
pdf("DVI_2022_plot.pdf")
plot(dvi_2022, col=cl)
title(main="DVI 2022")
dev.off()
...
pdf("differenza_DVI_plot.pdf")
plot(dvi_diff, col=cld)
title(main="DVI 2015 - DVI 2022")
dev.off()
...
pdf("NDVI_2015_plot.pdf")
plot(ndvi_2015, col=cl)
title(main = "NDVI 2015")
dev.off()
...
pdf("NDVI_2022_plot.pdf")
plot(ndvi_2022, col=cl)
title(main = "NDVI 2022")
dev.off()
...
# classe 1: aree di vegetazione (appare di colore rsso)
# classe 2: aree di suolo nudo (appare di colore giallo) 

# 2015 Suddivisioni classi 
n2015_class <- unsuperClass(n2015, nClasses=2) 
clc <- colorRampPalette(c("yellow", "red")) (100)
plot(n2015_class$map, col=clc) + title(main ="suddivisione in classi 2015")

pdf("n2015_class_plot.pdf")
plot(n2015_class$map, col=clc)
title(main ="suddivisione in classi 2015")
dev.off()
...
# 2022 suddivisione in classi 
n2022_class <- unsuperClass(n2022, nClasses=2)
clc <- colorRampPalette(c("yellow", "red")) (100)
plot(n2022_class$map, col=clc) + title(main ="suddivisione in classi 2022")


pdf("n2022_class_plot.pdf")
plot(n2022_class$map, col=clc)
title(main ="suddivisione in classi 2022")
dev.off()
...
tot2015 <- 406516 # assegno il totale dei pixel della immagine del 2015 classificata a tot2015
...
percent_2015 <- c(74.65536, 25.34464) # assegno un vettore a un ogetto che rappresenta la seconda colonna 
percent_2022 <- c(66.09233, 33.9077) # assegno un vettore a un ogetto che rappresenta la terza colonna  
...
pdf("Percebtuale_2015_plot.pdf")
ggplot(multitemporal, aes(x=class, y=percent_2015, color=class)) + geom_bar(stat="identity", fill="white") +  ggtitle("percentuale 2015")
title(main = "percentuale 2015")
dev.off()

# Creo un istrgamma che rappresenti i dati percentuali ottenuti dalle due classi dell'immagine del 2022 classificata: 

# Plot percentuale 2022
perc_2022 <- ggplot(multitemporal, aes(x=class, y=percent_2022, color=class)) + 
             geom_bar(stat="identity", fill="white") + 
             ggtitle("percentuale 2022")

pdf("multitemporal_dataframe.pdf")
 ggplot(multitemporal, aes(x=class, y=percent_2022, color=class)) + 
             geom_bar(stat="identity", fill="white") + 
             ggtitle("percentuale 2022")
title(main = "percentuale 2022")
dev.off()
...
summary(n2015_pca$model) 
# proprortion of Variance: #PC1 spiega il 76.70% #PC2 spiega il 15.89%  #PC3 spiega il 5.99% 

# ogni percentuale la associo a uno oggetto per poi creare un dataframe:
